...
public class SettingsService
{
    ...
    {
        _torrentManagerService =
            torrentManagerService ?? throw new ArgumentNullException(nameof(torrentManagerService));
    ...
    private Settings CreateDefaultSettings()
    {
        ...
        {
            DefaultSaveLocation =
                Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "Torrents"),
    ...
    {
        if (_settings != null) await _torrentManagerService.SetSpeed(_settings.MaxDownloadSpeedKBps);
    }
